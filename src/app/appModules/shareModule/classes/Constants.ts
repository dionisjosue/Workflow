...
export class Constants
 {
    ...
    public static readonly GET_APICONFIG:string= "ApiConfiguration/GetApiConditionals";
    public static readonly CREATE_APICONFIG:string= "ApiConfiguration/CreateApiConfigurations";
    public static readonly EDIT_APICONFIG:string= "ApiConfiguration/EditApiConfigurations";
